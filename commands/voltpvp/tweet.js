...
class announceCommand extends commando.Command {
  constructor(client) 
  {
    super(client, {
      ...
      group: 'voltpvp',
      memberName: 'tweet',
      description: "Tweets a message in #twitter"
    });
  }
  ...
  async run (message, args)
  {
    ...
    let announcementmessage = announcementargs.join(" ").slice(6);
    ...
    .setTitle("**VoltPvP | Tweet**")
    .setColor("#FFDF00")
    .addField("**__Tweet__**", `${announcementmessage}`)
